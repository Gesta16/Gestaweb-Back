...
class LaboratorioITrimestreController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $validatedData = $request->validate([
                ...
                'fec_hemoclasificacion' => 'nullable|date',
                ...
                'ig_rubeola' => 'nullable|string',
                'fec_rubeola' => 'nullable|date',
                ...
                'igm_rubeola' => 'nullable|string',
                'fec_igm_rubeola' => 'nullable|date',
                ...
                'real_igm_rubeola' => 'required|boolean',
    ...
    public function update(Request $request, $id)
    {
        ...
        $validatedData = $request->validate([
            ...
            'rie_biopsicosocial' => 'nullable|string',
            'real_igm_rubeola' => 'required|boolean',
            'real_prueb_rapi_vih' => 'required|boolean',
            'reali_prueb_trepo_rapid_sifilis' => 'required|boolean',
            'realizo_urocultivo' => 'required|boolean',
